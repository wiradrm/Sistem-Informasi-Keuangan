...
<div class="row my-4">
      ...
      <div class="d-flex justify-content-start">
         <form class="form-inline">
            <div class="form-group">
               ...
               <input type="text" class="form-control" id="search" placeholder="Cari Data Pengeluaran" name="jenis_transaksi">
            </div>
         </form>
   ...
   <div class="col-md-6">
      <div class="d-flex justify-content-end">
         {{-- <a href="{{route('pengeluaran.export')}}" class="btn btn-info "><i class='bx bxs-printer' ></i> Cetak Laporan</a> --}}
         {{-- <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
               <a class="dropdown-item" href="{{route('pengeluaran')}}">Default</a>
            </div>
         </div> --}}
      </div>
   </div>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="text-center">
                     <a class="btn-table text-danger" href="" data-toggle="modal" data-target="#deleteModal-{{$item->id_transaksi}}"><i class='bx bxs-trash-alt'></i></a>
                     <a class="btn-table text-info" href="#" data-toggle="modal" data-target="#updateModal-{{$item->id_transaksi}}"><i class='bx bxs-edit' ></i></a>
                     <div class="modal fade" id="deleteModal-{{$item->id_transaksi}}" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                 ...
                                 <form action="{{route('pengeluaran.delete',$item->id_transaksi)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                     ...
                     <div class="modal fade bd-example-modal-lg text-left" id="updateModal-{{$item->id_transaksi}}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <form action="{{route('pengeluaran.update', $item->id_transaksi)}}" method="POST">
                              @csrf
                              @method('PUT')
                              <div class="modal-body">
