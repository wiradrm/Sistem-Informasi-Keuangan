...
<div class="row my-4">
   ...
   <div class="col-md-6">
      <div class="d-flex justify-content-end">
         {{-- <a href="{{route('anggaran.export')}}" class="btn btn-info "><i class='bx bxs-printer' ></i> Cetak Laporan</a> --}}
         {{-- <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
               <a class="dropdown-item" href="{{route('anggaran')}}">Default</a>
            </div>
         </div> --}}
      </div>
   </div>
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                 ...
                                 <form action="{{route('anggaran.delete',$item->id)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="jenis_anggaran" id="jenis_anggaran" class="form-control">
                                      <option value="{{$item->jenis_anggaran}}" selected hidden>{{$item->jenis_anggaran}}</option>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="anggaran" name="anggaran" value="{{$item->anggaran}}">
                                  </div>
                                  <div class="form-group">
